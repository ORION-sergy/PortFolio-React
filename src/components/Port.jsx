...
function Port (){
    ...
    return(
        <section className="portfolio" id="portfolio">
            ...
            {/* SLIDER 2 */}
            <div className={`w-full h-screen flex flex-col justify-center items-center fixed bg-black top-0 left-0 z-50 ${isSlider2Visible ? "block" : "hidden"}`}>
                <div className="mt-14 lg:w-[60vw] md:w-[90vw] w-[95vw] h-auto text-[#00abf0] text-2xl text-center">
